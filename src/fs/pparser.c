...
//This function createas a root for the path
...
//This funtion sets up the memory allocated for path parsing
...
//This is the main function for path parsing. It uses all the aboce functions to parse the provided path.
