...
#define CENTOS_PROGRAM_VIRTUAL_ADDRESS 0x400000
#define CENTOS_USER_PROGRAM_STACK_SIZE 1024 * 16
#define CENTOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START 0x3FF000
#define CENTOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END CENTOS_PROGRAM_VIRTUAL_ADDRESS_START - CENTOS_USER_PROGRAM_STACK_SIZE
